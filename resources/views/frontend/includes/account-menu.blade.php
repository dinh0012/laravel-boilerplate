<ul id="account-menu" class="nav">
    ...
    <li class="nav-item">
        <a class="nav-link" data-toggle="modal" data-target="#loginFormModal" href="#">sign up</a>
    </li>
    <li class=" nav-item seperate">
        <a class="nav-link" href="#">/</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" data-toggle="modal" data-target="#loginFormModal" href="#">sign in</a>
    </li>
</ul>
