    ...
    <div class="container">
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="home-tab">
                <form id="login-form">
                    ...
                    <div class="form-check">
                        ...
                        <a href="#" id="forgot-password" class="link-forgot-pw link-rnw">Forgot password? </a>
                    </div>
                    <div class="row">
                        <button type="submit" id="login-rnw" class="btn-login-rnw btn btn-login-form btn-rnw btn-rnw-yellow">SIGN IN</button>
                    </div>
                    <p id="login-or-text">OR</p>
                    <div class="row btn-fb">
                        <button type="submit" id="login-fb" class="btn-login-fb btn btn-login-form btn-rnw btn-rnw-yellow">SIGN IN with facebook</button>
                        <img src="{{asset('/img/frontend/fb.png')}}" alt="">
                    </div>
                    <p id="term-conditions-text">By signing in you accept the <a href="" class="link-rnw">Terms of Conditions</a></p>
                </form>
            </div>
            <div class="tab-pane fade" id="register" role="tabpanel" aria-labelledby="profile-tab">
                ...
                <div class="form-group">
                    <div class="input-placeholder">
                        <input type="password" name="confirm_password" class="form-control confirm-password password" required >
                        <div class="placeholder">
                ...
                <div class="row">
                    <button type="submit" id="register-rnw" class="btn btn-login-form btn-rnw btn-rnw-yellow btn-login-rnw">SIGN UP</button>
                </div>
                <p id="login-or-text">OR</p>
                <div class="row btn-fb">
                    <button type="submit" id="register-fb" class="btn btn-login-form btn-rnw btn-rnw-yellow btn-login-fb">SIGN UP with facebook</button>
                    <img src="{{asset('/img/frontend/fb.png')}}" alt="">
                </div>
                <p id="term-conditions-text">By signing up you accept the  <a href="" class="link-rnw">Terms of Conditions</a></p>
            </div>
        </div>
    </div>
</div>