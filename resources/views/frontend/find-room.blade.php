                                ...
                                <div class="filter-group-body">
                                    <div class="filter-item">
                                        <label for="sharedhousing1" class="form-check-label">
                                            <label class="checkbox">
                                                <input type="checkbox" id="sharedhousing1" class="form-check-input checkbox-input">
                                                <div class="check">
                                                    <img src="/img/frontend/check_off.png" alt="remember password">
                                                </div>
                                            </label>
                                    ...
                                    <div class="filter-item">
                                        <label for="sharedhousing2" class="form-check-label">
                                            <label class="checkbox">
                                                <input type="checkbox" id="sharedhousing2" class="form-check-input checkbox-input">
                                                <div class="check">
                                                    <img src="/img/frontend/check_off.png" alt="remember password">
                                                </div>
                                            </label>
                                ...
                                <div class="filter-group-body">
                                    <div class="filter-item">
                                        <label for="capacity1" class="form-check-label">
                                            <label class="checkbox">
                                                <input type="checkbox" id="capacity1" class="form-check-input checkbox-input">
                                                <div class="check">
                                                    <img src="/img/frontend/check_off.png" alt="remember password">
                                                </div>
                                            </label>
                                    ...
                                    <div class="filter-item">
                                        <label for="capacity2" class="form-check-label">
                                            <label class="checkbox">
                                                <input type="checkbox" id="capacity2" class="form-check-input checkbox-input">
                                                <div class="check">
                                                    <img src="/img/frontend/check_off.png" alt="remember password">
                                                </div>
                                            </label>
                                    ...
                                    <div class="filter-item">
                                        <label for="capacity3" class="form-check-label">
                                            <label class="checkbox">
                                                <input type="checkbox" id="capacity3" class="form-check-input checkbox-input">
                                                <div class="check">
                                                    <img src="/img/frontend/check_off.png" alt="remember password">
                                                </div>
                                            </label>
                                ...
                                <div class="filter-group-body">
                                    <div class="filter-item">
                                        <label for="Furniture1" class="form-check-label">
                                            <label class="checkbox">
                                                <input type="checkbox" id="Furniture1" class="form-check-input checkbox-input">
                                                <div class="check">
                                                    <img src="/img/frontend/check_off.png" alt="remember password">
                                                </div>
                                            </label>
                                    ...
                                    <div class="filter-item">
                                        <label for="Furniture2" class="form-check-label">
                                            <label class="checkbox">
                                                <input type="checkbox" id="Furniture2" class="form-check-input checkbox-input">
                                                <div class="check">
                                                    <img src="/img/frontend/check_off.png" alt="remember password">
                                                </div>
                                            </label>
